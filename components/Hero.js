  ...
  return (
    ...
    >
      <div
        ...
        } flex flex-col space-y-3 w-4/5 sm:w-3/4 md:w-[70%] justify-items-start transition-opacity ease-in duration-1000`}
      >
        ...
        <p
          className={`text-3xl text-gray-400 ${
            mounted ? "opacity-100" : "opacity-0"
          } transition-opacity ease-in delay-700 duration-700`}
        >
